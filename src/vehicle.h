...
class vehicle
{
    ...
    public:
        ...
        bool would_install_prevent_flyable( const vpart_info &vpinfo ) const;
        bool would_removal_prevent_flyable( vehicle_part &vp ) const;
        bool would_repair_prevent_flyable( vehicle_part &vp ) const;
        // Let's flip the script and check if installing this part would make the vehicle flyable.
        bool would_install_make_flyable( const vpart_info &vpinfo ) const;
        /**
