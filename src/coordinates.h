...
using point_om_sm = coords::coord_point<point, coords::origin::overmap, coords::sm>; // why was this called coord_point, idk
...
using tripoint_om_sm = coords::coord_point<tripoint, coords::origin::overmap, coords::sm>; // overmap submap
