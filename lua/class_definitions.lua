...
classes = {
    ...
    map = {
        ...
        functions = {
            ...
            { name = "set_field_age", rval = "time_duration", args = { "tripoint", "field_type_id", "time_duration" }, optional_args = { "bool" } },
            -- { name = "set_field_strength", rval = "int", args = { "tripoint", "field_type_str_id", "int" }, optional_args = { "bool" } }, -- not present but might be modernized somewhere TODO
